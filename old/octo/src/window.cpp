...
namespace octo
{
    ...
    {
        LogDebug("octo::Window: initializing...");
    ...
    bool Window::pollEvents()
    {
        ...
        {
            LogWarn("octo::Window::pollEvents: window does not exist");
            return false;
        }
    }
    ...
    void Window::_keyCallback(GLFWwindow *window, int key, int scancode, int action, int mods)
    {
        ...
        else
        {
            ...
            {
                LogDebug("octo::Window::_keyCallBack: key pressed:", key);
    ...
    void Window::_mouseButtonCallback(GLFWwindow *window, int button, int action, int mods)
    {
        ...
        else
        {
            ...
            {
                LogDebug("octo::Window::_mouseButtonCallBack: button pressed:", button);
