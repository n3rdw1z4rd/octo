...
OCTO_API void *_darray_create(u64 length, u64 stride);
OCTO_API void _darray_destroy(void *array);

OCTO_API u64 _darray_field_get(void *array, u64 field);
OCTO_API void _darray_field_set(void *array, u64 field, u64 value);

OCTO_API void *_darray_resize(void *array);

OCTO_API void *_darray_push(void *array, const void *value_ptr);
OCTO_API void _darray_pop(void *array, void *dest);

OCTO_API void *_darray_pop_at(void *array, u64 index, void *dest);
OCTO_API void *_darray_insert_at(void *array, u64 index, void *value_ptr);
