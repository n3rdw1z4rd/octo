...
namespace octo {
    ...
    void Renderer::createGraphicsPipeline() {
        ...
        auto vertShaderCode = CompileShaderSource("DEPTH_VERT_SHADER", DEPTH_VERT_SHADER, shaderc_vertex_shader);
        auto fragShaderCode = CompileShaderSource("DEPTH_FRAG_SHADER", DEPTH_FRAG_SHADER, shaderc_fragment_shader);
